...
crypto_list = [ 
 "BTCUSDT", "UNFIUSDT",
 "SRMUSDT", "DYDXUSDT",
 "SANDUSDT", "XRPUSDT", "DOTUSDT",
 "DOGEUSDT", "LINKUSDT", "AXSUSDT",
 "LTCUSDT", "RUNEUSDT", "STORJUSDT",
 "COMPUSDT", "FLMUSDT", "1INCHUSDT",
 "ZILUSDT", "LITUSDT", "PEOPLEUSDT", "BELUSDT", "RSRUSDT",
 "THETAUSDT", "SNXUSDT",
 "GTCUSDT", "EGLDUSDT", "JASMYUSDT", "ZECUSDT",
 "BATUSDT", "ALICEUSDT", "RENUSDT", "XLMUSDT",
 "QTUMUSDT", "NEOUSDT", "ARPAUSDT",
 "ENSUSDT", "CELRUSDT", "ATAUSDT", "SKLUSDT", "KNCUSDT", "IOTXUSDT",
 "ROSEUSDT",
 "AUDIOUSDT", "C98USDT", "WOOUSDT",
 "LRCUSDT", "CTKUSDT", "MKRUSDT", "DASHUSDT", "IOSTUSDT",
 "CTSIUSDT", "BNXUSDT", "HNTUSDT",
